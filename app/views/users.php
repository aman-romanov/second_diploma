                                    ...
                                    <div class="info-card-text flex-1">
                                        ...
                                        <?php if($auth['role'] == 1 || $auth['id'] == $user['id']): ?>
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="/marlin/second_diploma/edit/<?=$user['id']?>">
                                                    <i class="fa fa-edit"></i>
                                                Редактировать</a>
                                                <a class="dropdown-item" href="/marlin/second_diploma/security/<?=$user['id']?>">
                                                    <i class="fa fa-lock"></i>
                                                Безопасность</a>
                                                <a class="dropdown-item" href="/marlin/second_diploma/status/<?=$user['id']?>">
                                                    <i class="fa fa-sun"></i>
                                                Установить статус</a>
                                                <a class="dropdown-item" href="/marlin/second_diploma/media/<?=$user['id']?>">
                                                    <i class="fa fa-camera"></i>
                                                    Загрузить аватар
                                                </a>
                                                <a href="/marlin/second_diploma/delete/<?=$user['id']?>" class="dropdown-item" onclick="return confirm('are you sure?');">
        ...
        <footer class="page-footer" role="contentinfo">
            ...
            <div>
                <ul class="list-table m-0">
                    <li><a href="/marlin/second_diploma/users" class="text-secondary fw-700">Home</a></li>
